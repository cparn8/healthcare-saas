  ...
  return (
    <div className="flex justify-center items-center h-screen bg-bg dark:bg-bg-dark">
      <form
        ...
        noValidate
        className="bg-surface dark:bg-surface-dark border border-border dark:border-border-dark p-6 rounded-lg shadow-md w-96"
      >
        ...
        <input
          ...
          className="border border-border dark:border-border-dark bg-input-light dark:bg-input-dark p-2 w-full rounded mb-4"
